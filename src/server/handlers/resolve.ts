 ...
 * note rendered — the same link the server renderer writes into a rendered
 * wikilink's `href`.
 */
 ...
 * miss is `{target, record_id: null, file_path: null, ui_url: null}`. One
 * request resolves a rendered note's distinct wikilinks; one GET per link was
 * 145 round trips on a 900 KB note (2026-09-17).
 */

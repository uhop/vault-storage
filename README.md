...
| POST   | `/system/resume-bundle`         | One-shot session-start bundle for `/vault resume`: runs the incremental reindex, then packages lint (non-zero checks only), pending-suggestion counts by kind, the agent-workflow surface (Active section + clarify count), recent session-log `agent.summary` lines (`?logs=N`, default 3), and `?project=<name>`'s notes (feedback.md with full body; queue/decisions/learnings/stack as summaries + sizes). `?project_bodies=queue,decisions,…` opts additional project files into full-body delivery (wrap prep). Replaces the ~6 separate reads of the resume flow. POST because the embedded reindex writes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |

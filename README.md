...
| GET    | `/system/resume-brief`          | The token-tiered sibling of the bundle, sized for SessionStart-hook injection (the `bd prime` pattern): a few hundred bytes answering "should this session run a full `/vault resume`?" — lint ok + issue count, pending-suggestion total, agent-workflow flags, `?project=<name>`'s Active item titles + backlog/ready/blocked counts, a feedback.md pointer (updated date — never the body), and the latest session log's title + date. Strictly read-only (no reindex, no claim reverts); titles, counts, and dates only; unknown query params 400.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| GET    | `/sections`                     | List records. Filters: `type`, `status`, `tag` (CSV, alias-aware; unknown tags are a 400), `file_path` (alias: `path`), `file_prefix`, `priority_min/max`, `updated_since`, `record_ids`; plus `sort`, `exclude=body`. Pagination: `offset`, `limit` (max 100). Unknown query parameters are a 400 naming the offender — a typo'd filter fails loud instead of returning the unfiltered table.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
